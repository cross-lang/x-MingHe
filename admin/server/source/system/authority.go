...
func (i *initAuthority) InitializeData(ctx context.Context) (context.Context, error) {
	...
	entities := []sysModel.SysAuthority{
		{AuthorityId: 888, AuthorityName: "超级管理员", ParentId: utils.Pointer[uint](0), DefaultRouter: "dashboard", PInfo: "[]"},
		{AuthorityId: 666, AuthorityName: "开发者", ParentId: utils.Pointer[uint](0), DefaultRouter: "state", PInfo: "[]"},
	}
