...
func (i *initCasbin) InitializeData(ctx context.Context) (context.Context, error) {
	...
	entities := []adapter.CasbinRule{
		...
		// 版本管理
		{Ptype: "p", V0: "666", V1: "/sysVersion/findSysVersion", V2: "GET"},
		{Ptype: "p", V0: "666", V1: "/sysVersion/getSysVersionList", V2: "GET"},
		{Ptype: "p", V0: "666", V1: "/sysVersion/downloadVersionJson", V2: "GET"},
		{Ptype: "p", V0: "666", V1: "/sysVersion/exportVersion", V2: "POST"},
		{Ptype: "p", V0: "666", V1: "/sysVersion/importVersion", V2: "POST"},
		{Ptype: "p", V0: "666", V1: "/sysVersion/deleteSysVersion", V2: "DELETE"},
		{Ptype: "p", V0: "666", V1: "/sysVersion/deleteSysVersionByIds", V2: "DELETE"},

		// 参数管理
		{Ptype: "p", V0: "666", V1: "/sysParams/createSysParams", V2: "POST"},
		{Ptype: "p", V0: "666", V1: "/sysParams/deleteSysParams", V2: "DELETE"},
		{Ptype: "p", V0: "666", V1: "/sysParams/deleteSysParamsByIds", V2: "DELETE"},
		{Ptype: "p", V0: "666", V1: "/sysParams/updateSysParams", V2: "PUT"},
		{Ptype: "p", V0: "666", V1: "/sysParams/findSysParams", V2: "GET"},
		{Ptype: "p", V0: "666", V1: "/sysParams/getSysParamsList", V2: "GET"},
		{Ptype: "p", V0: "666", V1: "/sysParams/getSysParam", V2: "GET"},

		// 公共
		{Ptype: "p", V0: "666", V1: "/info/createInfo", V2: "POST"},
		{Ptype: "p", V0: "666", V1: "/info/deleteInfo", V2: "DELETE"},
		{Ptype: "p", V0: "666", V1: "/info/deleteInfoByIds", V2: "DELETE"},
		{Ptype: "p", V0: "666", V1: "/info/updateInfo", V2: "PUT"},
		{Ptype: "p", V0: "666", V1: "/info/findInfo", V2: "GET"},
		{Ptype: "p", V0: "666", V1: "/info/getInfoList", V2: "GET"},

		// 错误
		{Ptype: "p", V0: "666", V1: "/sysError/createSysError", V2: "POST"},
		{Ptype: "p", V0: "666", V1: "/sysError/deleteSysError", V2: "DELETE"},
		{Ptype: "p", V0: "666", V1: "/sysError/deleteSysErrorByIds", V2: "DELETE"},
		{Ptype: "p", V0: "666", V1: "/sysError/updateSysError", V2: "PUT"},
		{Ptype: "p", V0: "666", V1: "/sysError/findSysError", V2: "GET"},
		{Ptype: "p", V0: "666", V1: "/sysError/getSysErrorList", V2: "GET"},
		{Ptype: "p", V0: "666", V1: "/sysError/getSysErrorSolution", V2: "GET"},

		// 导出模板
		{Ptype: "p", V0: "666", V1: "/sysExportTemplate/createSysExportTemplate", V2: "POST"},
		{Ptype: "p", V0: "666", V1: "/sysExportTemplate/deleteSysExportTemplate", V2: "DELETE"},
		{Ptype: "p", V0: "666", V1: "/sysExportTemplate/deleteSysExportTemplateByIds", V2: "DELETE"},
		{Ptype: "p", V0: "666", V1: "/sysExportTemplate/updateSysExportTemplate", V2: "PUT"},
		{Ptype: "p", V0: "666", V1: "/sysExportTemplate/findSysExportTemplate", V2: "GET"},
		{Ptype: "p", V0: "666", V1: "/sysExportTemplate/getSysExportTemplateList", V2: "GET"},
		{Ptype: "p", V0: "666", V1: "/sysExportTemplate/exportExcel", V2: "GET"},
		{Ptype: "p", V0: "666", V1: "/sysExportTemplate/exportTemplate", V2: "GET"},
		{Ptype: "p", V0: "666", V1: "/sysExportTemplate/previewSQL", V2: "GET"},
		{Ptype: "p", V0: "666", V1: "/sysExportTemplate/importExcel", V2: "POST"},

		// 按钮权限
		{Ptype: "p", V0: "666", V1: "/authorityBtn/setAuthorityBtn", V2: "POST"},
		{Ptype: "p", V0: "666", V1: "/authorityBtn/getAuthorityBtn", V2: "POST"},
		{Ptype: "p", V0: "666", V1: "/authorityBtn/canRemoveAuthorityBtn", V2: "POST"},

		// 发送邮件
		{Ptype: "p", V0: "666", V1: "/email/emailTest", V2: "POST"},
		{Ptype: "p", V0: "666", V1: "/email/sendEmail", V2: "POST"},

		// 断点续传
		{Ptype: "p", V0: "666", V1: "/simpleUploader/upload", V2: "POST"},
		{Ptype: "p", V0: "666", V1: "/simpleUploader/checkFileMd5", V2: "GET"},
		{Ptype: "p", V0: "666", V1: "/simpleUploader/mergeFileMd5", V2: "GET"},

		// 系统字典详情
		{Ptype: "p", V0: "666", V1: "/sysDictionaryDetail/findSysDictionaryDetail", V2: "GET"},
		{Ptype: "p", V0: "666", V1: "/sysDictionaryDetail/updateSysDictionaryDetail", V2: "PUT"},
		{Ptype: "p", V0: "666", V1: "/sysDictionaryDetail/createSysDictionaryDetail", V2: "POST"},
		{Ptype: "p", V0: "666", V1: "/sysDictionaryDetail/getSysDictionaryDetailList", V2: "GET"},
		{Ptype: "p", V0: "666", V1: "/sysDictionaryDetail/deleteSysDictionaryDetail", V2: "DELETE"},
		{Ptype: "p", V0: "666", V1: "/sysDictionaryDetail/getDictionaryTreeList", V2: "GET"},
		{Ptype: "p", V0: "666", V1: "/sysDictionaryDetail/getDictionaryTreeListByType", V2: "GET"},
		{Ptype: "p", V0: "666", V1: "/sysDictionaryDetail/getDictionaryDetailsByParent", V2: "GET"},
		{Ptype: "p", V0: "666", V1: "/sysDictionaryDetail/getDictionaryPath", V2: "GET"},

		// 系统字典
		{Ptype: "p", V0: "666", V1: "/sysDictionary/findSysDictionary", V2: "GET"},
		{Ptype: "p", V0: "666", V1: "/sysDictionary/updateSysDictionary", V2: "PUT"},
		{Ptype: "p", V0: "666", V1: "/sysDictionary/getSysDictionaryList", V2: "GET"},
		{Ptype: "p", V0: "666", V1: "/sysDictionary/createSysDictionary", V2: "POST"},
		{Ptype: "p", V0: "666", V1: "/sysDictionary/deleteSysDictionary", V2: "DELETE"},
		{Ptype: "p", V0: "666", V1: "/sysDictionary/importSysDictionary", V2: "POST"},
		{Ptype: "p", V0: "666", V1: "/sysDictionary/exportSysDictionary", V2: "GET"},

		// 代码生成器
		{Ptype: "p", V0: "666", V1: "/autoCode/getDB", V2: "GET"},
		{Ptype: "p", V0: "666", V1: "/autoCode/getMeta", V2: "POST"},
		{Ptype: "p", V0: "666", V1: "/autoCode/preview", V2: "POST"},
		{Ptype: "p", V0: "666", V1: "/autoCode/getTables", V2: "GET"},
		{Ptype: "p", V0: "666", V1: "/autoCode/getColumn", V2: "GET"},
		{Ptype: "p", V0: "666", V1: "/autoCode/rollback", V2: "POST"},
		{Ptype: "p", V0: "666", V1: "/autoCode/createTemp", V2: "POST"},
		{Ptype: "p", V0: "666", V1: "/autoCode/delSysHistory", V2: "POST"},
		{Ptype: "p", V0: "666", V1: "/autoCode/getSysHistory", V2: "POST"},
		{Ptype: "p", V0: "666", V1: "/autoCode/createPackage", V2: "POST"},
		{Ptype: "p", V0: "666", V1: "/autoCode/getTemplates", V2: "GET"},
		{Ptype: "p", V0: "666", V1: "/autoCode/getPackage", V2: "POST"},
		{Ptype: "p", V0: "666", V1: "/autoCode/delPackage", V2: "POST"},
		{Ptype: "p", V0: "666", V1: "/autoCode/createPlug", V2: "POST"},
		{Ptype: "p", V0: "666", V1: "/autoCode/installPlugin", V2: "POST"},
		{Ptype: "p", V0: "666", V1: "/autoCode/pubPlug", V2: "POST"},
		{Ptype: "p", V0: "666", V1: "/autoCode/addFunc", V2: "POST"},
		{Ptype: "p", V0: "666", V1: "/autoCode/mcp", V2: "POST"},
		{Ptype: "p", V0: "666", V1: "/autoCode/mcpTest", V2: "POST"},
		{Ptype: "p", V0: "666", V1: "/autoCode/mcpList", V2: "POST"},

		// 系统
		{Ptype: "p", V0: "666", V1: "/system/getSystemConfig", V2: "POST"},
		{Ptype: "p", V0: "666", V1: "/system/setSystemConfig", V2: "POST"},
		{Ptype: "p", V0: "666", V1: "/system/getServerInfo", V2: "POST"},

		// 文件上传下载
		{Ptype: "p", V0: "666", V1: "/fileUploadAndDownload/findFile", V2: "GET"},
		{Ptype: "p", V0: "666", V1: "/fileUploadAndDownload/breakpointContinueFinish", V2: "POST"},
		{Ptype: "p", V0: "666", V1: "/fileUploadAndDownload/breakpointContinue", V2: "POST"},
		{Ptype: "p", V0: "666", V1: "/fileUploadAndDownload/removeChunk", V2: "POST"},
		...
		{Ptype: "p", V0: "666", V1: "/fileUploadAndDownload/importURL", V2: "POST"},
		...
		// 角色
		{Ptype: "p", V0: "666", V1: "/authority/copyAuthority", V2: "POST"},
		{Ptype: "p", V0: "666", V1: "/authority/updateAuthority", V2: "PUT"},
		...
		{Ptype: "p", V0: "666", V1: "/api/deleteApisByIds", V2: "DELETE"},
		{Ptype: "p", V0: "666", V1: "/api/syncApi", V2: "GET"},
		{Ptype: "p", V0: "666", V1: "/api/getApiGroups", V2: "GET"},
		{Ptype: "p", V0: "666", V1: "/api/enterSyncApi", V2: "POST"},
		{Ptype: "p", V0: "666", V1: "/api/ignoreApi", V2: "POST"},
		...
		{Ptype: "p", V0: "666", V1: "/user/setSelfSetting", V2: "PUT"},
