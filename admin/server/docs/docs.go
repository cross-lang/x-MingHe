...
const docTemplate = `{
    ...
    "paths": {
            ...
            "get": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "collectionFormat": "multi",
                        "description": "拉黑状态列表（1：未拉黑；2：已拉黑）",
                        "name": "block_statuses",
                        "in": "query"
                    },
                    {
                        ...
                        "collectionFormat": "multi",
                        "description": "实名状态列表（0：未认证；2：已认证）",
                        "name": "verify_statuses",
                        "in": "query"
                    },
                    {
                        "type": "string",
                            ...
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        ...
                                        "data": {
                                            "$ref": "#/definitions/response.UserItem"
                                        }
                                    }
                                }
                            ]
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.CreateEnterpriseParams"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.TopEnterpriseParams"
                        }
                    }
                ],
                "responses": {
        ...
        "/enterprises/updateStatus": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "更新企业状态信息",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.UpdateEnterpriseStatusParams"
                        }
                    }
                ],
                "responses": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/response.DistrictListResponse"
                                        }
                                    }
                                }
                            ]
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/response.DistrictTreeResponse"
                                            }
                                        }
                                    }
                                }
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.ChangeParkReq"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "用户修改当前园区",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/response.Response"
    ...
    "definitions": {
        ...
        "request.CreateEnterpriseParams": {
            "type": "object",
            "required": [
                "category",
                "contact",
            ...
            "properties": {
                ...
                "lease": {
                    ...
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/request.CreateEnterpriseLease"
                    }
                },
                "p_id": {
                    "description": "园区id",
        ...
        "request.UpdateEnterpriseStatusParams": {
            "type": "object",
            "required": [
                "id",
                "status"
        ...
        "request.UpdateUserReq": {
            ...
            "properties": {
                ...
                "education_experience": {
                    ...
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/request.UserExperience"
                    }
                },
                "enterprise_roles": {
                    "description": "企业和企业角色信息",
                    "type": "array",
                    "items": {
                        "type": "object",
                        "properties": {
        ...
        "response.DistrictListResponse": {
            ...
            "properties": {
                "items": {
                    ...
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/response.DistrictDetail"
                    }
                }
            }
        },
        "response.DistrictTreeResponse": {
            "type": "object",
            "properties": {
                "children": {
                    "description": "子节点",
        ...
        "response.UserItem": {
            ...
            "properties": {
                ...
                "deactivate_status": {
                    "description": "用户注销状态（0：未注销，1：注销中，2：已注销）",
                    "type": "integer"
                },
                "deleted_at": {
                    "description": "删除时间",
                ...
                "verification_status": {
                    "description": "实名认证状态（1：已认证，0：未认证）",
                    "type": "integer"
                },
                "work_years": {
                    "description": "工作年限",
        ...
        "system.SysAuthority": {
            ...
            "properties": {
                ...
                "p_info": {
                    "description": "园区ID列表,[{\"id\": 1, \"park_name\": \"高新园区\"}]",
                    "type": "string"
                },
                "parentId": {
                    "description": "父角色ID",
